          ...
          <Accordion type="single" collapsible className="space-y-6">
            ...
            >
              ...
              <AccordionContent className="text-lg text-gray-600">
                ...
                <br /> Исполнительные производства в отношении должника
                ...
                должен: <br /> 1. Все долги списываются. <br /> 2. Снимаются все
                ограничения, связанные с судебным производством. <br />
                Есть ли негативные моменты? Их минимум! Большинство граждан они
                никак не затронут: <br /> При обращении за кредитом нужно
                указывать свой статус банкрота в течение пяти лет. Несмотря на
                это, кредиты брать по-прежнему можно. Не менее 3-х лет нельзя
                участвовать в управлении организацией. В течение пяти лет нельзя
                повторно пройти процедуру банкротства
              </AccordionContent>
            </AccordionItem>
